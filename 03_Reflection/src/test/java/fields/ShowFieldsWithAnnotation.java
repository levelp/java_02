    ...
    private static void showFields(Object obj) {
        ...
        for (Field field : c.getDeclaredFields()) {
            ...
            try {
                ...
                PrintHashesBefore hashesBefore =
                        field.getAnnotation(PrintHashesBefore.class);
                if (hashesBefore != null) {
                    for (int i = 0; i < hashesBefore.value(); i++) {
                        System.out.print("#");
                    }
                    System.out.print(" ");
                }
                ...
                System.out.println("show.spaces() = " + show.spaces());
